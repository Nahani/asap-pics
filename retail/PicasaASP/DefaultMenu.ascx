<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DefaultMenu.ascx.cs" Inherits="Menu" %>
<ul class="art-menu">
	...
	<li><a href="download/"><span class="l"></span><span class="r"></span><span class="t">
	Asap App</span></a></li>
    <% if (Session["id"] != null)
       { %>
